...
std::shared_ptr<support::script_engine_map<quickjs_engine>> shared_tlmap() {
    static auto tlmap = std::make_shared<support::script_engine_map<quickjs_engine>>();
    return tlmap;
}
...
extern "C" char* wilton_module_init() {
    try {
        ...
        wilton::support::register_wiltoncall("runscript_quickjs", wilton::quickjs::runscript);
        wilton::support::register_wiltoncall("rungc_quickjs", wilton::quickjs::rungc);
        return nullptr;
